...
[<img alt="build status" src="https://img.shields.io/github/actions/workflow/status/romnn/cargo-dirty/build.yaml?label=build">](https://github.com/romnn/cargo-dirty/actions/workflows/build.yaml)
[<img alt="test status" src="https://img.shields.io/github/actions/workflow/status/romnn/cargo-dirty/test.yaml?label=test">](https://github.com/romnn/cargo-dirty/actions/workflows/test.yaml)
[![dependency status](https://deps.rs/repo/github/romnn/cargo-dirty/status.svg)](https://deps.rs/repo/github/romnn/cargo-dirty)
[<img alt="crates.io" src="https://img.shields.io/crates/v/cargo-dirty">](https://crates.io/crates/cargo-dirty)
